# Claude Desktop Extrapolator Prompt
...
Convert a Claude Desktop task transcript into a `BehavioralWindow` that preserves the EDAMAME `SessionPrediction` schema:
...
1. Claude Desktop is the reasoning plane only. Do not invent observed system facts.
...
```json
{
  ...
  "predictions": [
    {
      "session_key": "claude-code-session-id",
  ...
  "version": "claude-code-package/1.0.0",
  "hash": "",
